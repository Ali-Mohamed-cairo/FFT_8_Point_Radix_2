...
HD_PWD='O:/ADI_Internship/Assignments/FFT_Final_Project/FFT_8_Point_Radix_2_FPGA/FFT_8_Point_Radix_2_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_8_Point_Radix_2_Wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FFT_8_Point_Radix_2_Wrapper.tcl -notrace
